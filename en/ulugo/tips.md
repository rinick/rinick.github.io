...
| Replace or insert a move | In **Replace move** mode, left-click to replace the next move and right-click to insert a move before it. If the next node is a setup move, Ulugo inserts automatically |
