...
| 烈度 | 棋局当前战斗的激烈程度；数值是当前一方虚手而不是下最佳着手时会损失的目数，背景区域会在零线上下对称显示 |
...
“烈度显示上限”默认为 `25`。坐标范围只会随实际烈度逐步扩大，直到这个上限。如果目差或损失目数本来就需要更大的坐标范围，烈度可以使用该范围，但不会单独将其继续撑大。
