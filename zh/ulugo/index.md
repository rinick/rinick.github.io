...
逐手记谱、定期拍照追加盘面，或修正之前记错的着手，请查看 [记谱](./record.html)。

### 极简模式

极简模式会隐藏大部分界面，让棋盘尽可能占满窗口，适合[记谱](./record.html)或在手机、平板上使用。右上角的圆形按钮可以临时打开手数、坐标、基础工具和右侧面板。
...
| 功能 | 相关文档 |
| --- | --- |
| 逐手记谱、拍照续录或修正错记着手 | [记谱](./record.html) |
